...
import { hobbies, tones } from '../data'
...
const extHeight = () => (window.innerWidth <= 720 ? 220 : 160)
...
/* Gravity sandbox + hidden game. Stickers pile in the bordered box (which is
   ...
   matter-js is heavy, so this whole component is lazy-loaded (React.lazy) and
   only mounted once the About section scrolls near — keeping the physics engine
